...
const Login = () => {
    ...
    return (
        <LoginContainer className='container'>
            <ImageContainer>
                <BgImage src={BG} alt="background-picture" />
            </ImageContainer>
            ...
            <FormContainer className='loginFormContainer'>
                ...
                <FormComp className='loginForm' action="">
                    ...
                    <Field>
                        ...
                        <Textfield onChange={handlePassword} value={password} type="text" name="password" id="" />
                    </Field>
                    <Options>
                        <Form>
            ...
            <Signup>
                ...
                <SignupText style={{ color: '#1F8C76', fontWeight: '500', cursor: 'pointer' }}>Sign up</SignupText>
            </Signup>
        </LoginContainer>
    )
}
